const textObj = {
 ...
 <main class="content-horizontal-center content-vertical-center">
   <div class="w-l text-justify">
       ...
       <br>
       <section>
       Das Ziel der Studie ist es, erneut Ihre Einstellung zum Klimawandel zu messen. Dafür setzen wir eine Methode ein, die "Cognitive-Affective Mapping" (CAM-Methode) heißt und bei der Sie eine Art Mind-Map zeichnen werden. 
 ...
 <main class="content-horizontal-center content-vertical-center">
   <div class="w-l text-justify">
       ...
       (<a href="mailto:julius.fenn@psychologie.uni-freiburg.de">julius.fenn@psychologie.uni-freiburg.de</a>), 
        Christophe Becht (<a href="mailto:christophe.becht@students.uni-freiburg.de">christophe.becht@students.uni-freiburg.de</a>)
...
<footer class="content-vertical-center content-horizontal-right">
 ...
 <footer class="content-vertical-center content-horizontal-right">
   ...
   <header>
     <h2>
     Bitte lesen Sie den folgenden Text sorgfältig durch. Anschließend bitten wir Sie, eine <i>Mind-Map</i> zu Ihren Einstellungen und Gefühlen zu Klimawandel zu zeichnen.
     </h2>
   </header>
