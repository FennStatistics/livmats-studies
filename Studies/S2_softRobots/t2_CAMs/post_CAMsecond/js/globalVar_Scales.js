...
let KoverolaList = {
  ques: ["Ich kann Personen und Organisationen, die mit der Entwicklung von Robotern zu tun haben, vertrauen.",
    ...
    "Ich würde mich unbhaglich dabei fühlen, wenn ich einen Job bekommen würde bei dem ich mit Robotern arbeiten müsste", "Ich befürchte, dass Roboter meine Anweisungen nicht verstehen wüden.",
    "Roboter machen mir Angst.", "Ich würde mich sehr nervös fühlen, allein in der Nähe eines Roboters zu sein.",
    ...
    "Roboter können das Leben einfacher machen. ", "Die Zuweisung von Routineaufgaben an Roboter ermöglicht es den Menschen, bedeutungsvollere Aufgaben zu erledigen",
